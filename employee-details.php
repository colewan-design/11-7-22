		...
		<div class="main-container">
            ...
            ?>
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="process.php?admin_id=<?php echo $admin_id ?>&employeeallowanceDelete=<?php echo $row['eaID']; ?>">
            ...
            ?>
					<div class="card-box mb-30" style="width: 45%; float:right;">
						<div class="pd-20 pb-10 d-flex justify-content-center">
							...
							<button style="margin-left:1rem;"type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-employee-deduction">Mandatory</button>
							<button style="margin-left:1rem;"type="button" class="btn btn-primary" data-toggle="modal" data-target="#add-other-deduction">Other</button>
									...
									<div class="modal-dialog modal-dialog-centered">
										<div class="modal-content">
											...
											<div class="modal-body">
												...
												<div class="form-group">
														<label class="col-sm-12 col-md-4 col-form-label">Deduction List</label>
														<select class="selectpicker" name="otherDeductionId" id="" style="width: 250px;">
																<option value="">Select</option>
																<?php
													...
													<div class="form-group">
													<label class="col-sm-12 col-md-6 col-form-label">Deduction Amount</label>
													<input style="width: 200px;" name="employeeOtherDeductionAmount"  class="form-control" type="text" placeholder="Enter Amount" required>
														
													</div>
                                                  
                                                    <div>
                                                    <button style="margin-left: 1rem;"type="submit" name="addEmployeeOtherDeduction" value="process.php?addEmployeeOtherDeduction" class="btn btn-primary">
													Insert
												    </button>
                                                    <button style="position: absolute; margin-left: 1rem; bottom: 1rem;" type="button" class="btn btn-secondary" data-dismiss="modal">
													Close
            ...
            ?>
                ...
                <tr>
                    ...
                    <td align="center">
                        <a href="process.php?admin_id=<?php echo $admin_id; ?>&employeeDeductionDelete=<?php echo $row['edID']; ?>">
                            <class class="btn btn-danger btn-sm">Delete</class>
                        </a>
                ...
                <tr>
                    ...
                    <td><?php echo $rows['employeeOtherDeductionAmount']; ?></td>
                  
                    <td align="center">
                        <a href="process.php?admin_id=<?php echo $admin_id; ?>&employeeotherdeductionDelete=<?php echo $rows['odId']; ?>">
                            <class class="btn btn-danger btn-sm">Delete</class>
                        </a>
