				...
				<div class="min-height-200px">
					...
					<div class="card-box mb-30">
						<div class="pd-20 pb-10 d-flex justify-content-center">
							<h4 class="text h4">CALCULATIONS - INCENTIVE</h4>
						</div>
									...
									<div class="modal-dialog modal-dialog-centered">
										...
										<form method="POST" action="save_incentive.php">
												<div style="background: #98FB98;"class="modal-header">
													<h3 class="modal-title">Add New Incentive</h3>
												</div>
												<div class="modal-body">
													...
													<div class="col-md-8">
														...
														<div class="form-group">
														<label>Type</label>
														<select class="selectpicker"name="allowanceType" id="" style="width: 250px;">
						...
						<div class="pb-20">
							<table class=" table stripe hover nowrap">
								<thead class="text-white bg-secondary">
									<tr>
										<th class="table-plus datatable">Incentive Name</th>
                                        <th>Description</th>
										<th>Amount</th>
										<th>Type</th>
                                        <th>Actions</th>
                                ...
                                <?php
                                    ...
                                    <tr>
										...
										<td><?php 
										$allowanceAmount = $fetch['allowanceAmount'];
										$allowanceType = $fetch['allowanceType'];
										if($allowanceType == 'percentage') {
											echo $allowanceAmount . '%';
										} else{
										
											echo number_format($allowanceAmount,2) ;
											
										}?></td>
                                       <td><?php echo $fetch['allowanceType']?></td>

										
                                        <td>
										
										<button class=" btn btn-warning" data-toggle="modal" type="button" data-target="#update_modal<?php echo $fetch['allowanceId']?>">
												...
												<div class="modal-content">
													<form method="POST" action="update_incentive.php">
														<div style="background:#AFEEEE;" class="modal-header">
															<h3  class="modal-title">Update Incentives</h3>
														</div>
