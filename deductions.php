...
<html>
	<head>
		<!-- Basic Page Info -->
		<meta charset="utf-8" />
		<title>CALCULATIONS - MANDATORY DEDUCTIONS | CBOO</title>
												...
												<div class="modal-body">
													...
													<div class="col-md-8">
														<div class="form-group">
															...
															<input type="text" name="deductionName" class="form-control" required="required"/>
														</div>
														<div class="form-group">
                                                        ...
                                                        <label>Deduction Limit</label>
                                                            <div>
                                                                <input class="form-control" min="1" step="0.01" name="deductionLimit"  type="number" placeholder="Enter Maximum Deduction">
                                                            </div>
                                                        </div>
													</div>
												</div>
							...
							<table class="data-table table stripe hover nowrap">
                                ...
                                <?php
                                    ...
                                    <tr>
										...
										<button class=" btn btn-warning" data-toggle="modal" type="button" data-target="#update_modal<?php echo $fetch['deductionId']?>">
										<i class="fas fa-edit"></i></button>

										<!--The update_modal modal -->
											<div class="modal fade" id="update_modal<?php echo $fetch['deductionId']?>" aria-hidden="true">
														...
														<div style="text-align:center;background:#E0FFFF;" class="modal-body">
															...
															<div class="col-md-8">
																<div class="form-group">
																	...
																	<input type="text" name="deductionName" value="<?php echo $fetch['deductionName']?>" class="form-control" required="required"/>
																</div>
																<div class="form-group">
																	<label>Description</label>
																	<input type="text" name="description" value="<?php echo $fetch['description']?>" class="form-control" required="required" />
																</div>

                                                                <label>Amount</label>
																<div class="form-group">
																
																	<input type="text" name="amount" value="<?php echo $fetch['amount']?>" class="form-control" required="required" />
                                                                ...
                                                                <label>Deduction Limit</label>
                                                                    <div>
                                                                        <input class="form-control" min="1" step="0.01" name="deductionLimit" value="<?php echo $fetch['deductionLimit']?>"  type="number" placeholder="Enter Maximum Deduction">
                                                                    </div>
                                                                </div>
															</div>
														</div>
											...
											<a href="process.php?deductionDelete=<?php echo $fetch['deductionId']; ?>">
