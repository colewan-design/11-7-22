												...
												<div class="modal-body">
													...
													<div class="col-md-8">
														<div class="form-group">
															...
															<input type="number"  name="salaryGrade" class="form-control" required="required"/>
														</div>
														<div class="form-group">
															<label>Step</label>
															<input type="number" step="1" name="salaryStep" class="form-control" required="required" />
														</div>
                                ...
                                <?php
                                    ...
                                    <tr>
										...
										<!--The update_modal modal -->
											...
											<a onclick="return confirm('Are you sure you want to delete this salary?');"
											 href="process.php?salaryDelete=<?php echo $fetch['id']; ?>">
